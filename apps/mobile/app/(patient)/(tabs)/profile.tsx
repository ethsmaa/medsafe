...
export default function ProfileScreen() {
	...
	const handleLogout = async () => {
		...
		try {
			// 1. Stop all outgoing requests immediately
			await queryClient.cancelQueries();
			// 2. Clear the cache (removes all data, doesn't trigger refetch)
			queryClient.clear();

			// 3. Sign out (network request)
			...
			// In case component receives updates before unmounting
				...
				<View style={styles.section}>
					...
					>
						...
						>
							...
							/>
							<Text style={styles.label}>Manage Caregivers</Text>
						</View>
